...
public class PanelArmas extends JPanel implements ActionListener, MouseListener {
	...
	public PanelArmas(Model model, PanelPersonajes pPersonajes) {
		...
		btnEliminarTodo = new JButton("Eliminar todos los datos");
		btnEliminarTodo.setBounds(40, 229, 181, 23);
		btnEliminarTodo.addActionListener(this);
		btnEliminarTodo.setActionCommand("eliminartodo");
		btnEliminarTodo.setBorder(BorderFactory.createRaisedSoftBevelBorder());
	...
	public void modoEdicion(boolean activo) {
		...
		if(borrado) 
			botonesCrud.btnRecuperar.setEnabled(true);
		else
			botonesCrud.btnRecuperar.setEnabled(false);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		switch(actionCommand) {
			...
			case "eliminartodo":
				...
				limpiar();
				modoEdicion(false);
				pPersonajes.panelAnadirArma.modeloLista.removeAllElements();
				break;
			default:
				break;
		}
