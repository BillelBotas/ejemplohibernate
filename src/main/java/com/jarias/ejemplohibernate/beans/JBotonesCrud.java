...
public class JBotonesCrud extends JPanel {
	public JButton btnNuevo, btnGuardar, btnEliminar, btnCancelar, btnEditar, btnRecuperar;
	...
	public JBotonesCrud() {
		...
		btnRecuperar.setBorder(BorderFactory.createRaisedSoftBevelBorder());
		btnRecuperar.setBounds(10, 79, 89, 23);
